...
#  password.
#  Default: ''
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$FQKSMQa3QWjxIjMyc2TbUA$HjuPAjk973Nb+8g9OD+8xg'
...
#  Choices: any of ['sha3_384', 'sha256', 'sha1', 'blake2b', 'sha384', 'md5', 'sha512', 'sha3_256', 'blake2s', 'sha224', 'sha3_512', 'sha3_224']
#  Default: 'sha256'
